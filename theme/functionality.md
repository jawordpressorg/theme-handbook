...
さて、テーマ開発の基本を理解したところで、テーマの世界をさらに深く掘り下げていきましょう。本セクションでは、あなたのテーマを作成する際に考慮すべき、基本的なテーマ機能のすべてを扱います:
...
*   [カスタムヘッダー](https://developer.wordpress.org/themes/functionality/custom-headers/ "Custom Headers") – あなたのユーザーが独自のヘッダー画像を追加できるようにする、柔軟性の実装方法を学びます。
...
*   [アイキャッチ画像 & 投稿サムネイル](https://developer.wordpress.org/themes/functionality/featured-images-post-thumbnails/ "Featured Images & Post Thumbnails") – 投稿サムネイルの扱いやカスタマイズを行います。
*   [投稿フォーマット](https://developer.wordpress.org/themes/functionality/post-formats/ "Post Formats") – ユーザーの投稿を表示するための、さまざまなフォーマットを作成します。
*   [国際化](https://developer.wordpress.org/themes/functionality/internationalization/ "Internationalization") – あなたのテーマをさまざまな言語に翻訳するための、準備方法を学びます。
*   [ローカライズ](https://developer.wordpress.org/themes/functionality/localization/ "Localization") – WordPress テーマの翻訳方法を学びます。
*   [アクセシビリティ](https://developer.wordpress.org/themes/functionality/accessibility/ "Accessibility") – すべてのユーザーがあなたのテーマを利用できるよう、アクセシビリティのベストプラクティスについて学びます。
*   [管理メニュー](https://developer.wordpress.org/themes/functionality/administration-menus/ "Administration Menus") – WordPress 管理画面に、メニュー項目を追加します。
*   [404エラーページ](https://developer.wordpress.org/themes/functionality/404-pages/ "Creating a 404 Page") – カスタム404エラーページを作成します。
...
テーマが初めての方は、各セクションを順番に学ぶことをおすすめしますが、特定のものを探している場合は、そのセクションに移動できます。